...
export const hoverEffect = function(opts) {
	...
	var fragment = `
        ...
        void main() {
            ...
            vec2 distortedPosition = vec2(uv);
            vec2 distortedPosition2 = vec2(uv.x + (1.0 - dispFactor) * disp.r*effectFactor, uv.y);

            vec4 _tex = texture2D(tex, distortedPosition);
            vec4 _tex2 = texture2D(tex2, distortedPosition2);

            vec4 finalTex = mix(_tex, _tex2, dispFactor);
	...
	loader.crossOrigin = ''
	var tex1 = loader.load(image1)
	var tex2 = loader.load(image2)
	...
	tex1.anisotropy = renderer.capabilities.getMaxAnisotropy()
