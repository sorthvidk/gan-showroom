		...
		<div class="window__content">
			<div class="assistant">
				...
				>
					<div class="assistant__filters">
						...
						<p>
							...
							close up look at the collection, fall in love.
							<span v-if="currentCollectionFilters.length > 0"
						...
						<div class="assistant__filters__list">
							...
							<span
								class="filter-button"
								v-if="currentCollectionFilters.length % 2 > 0"
								>&nbsp;</span
							>
						</div>
					</div>
				...
				<div
					...
					v-if="assistantMode == 0 && activeWishlist.length > 0"
				>
					<button
				...
				<div class="assistant__ctas" v-if="assistantMode == 2">
					...
					<button
						...
						:class="{
							...
							'is-animating': styleHasJustBeenAdded
						}"
