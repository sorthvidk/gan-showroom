<template>
	<vue-draggable-resizable class-name="window" class-name-active="is-active" @dragging="onDrag" @resizing="onResize" :handles="['br']" :drag-handle="'.window__top'" :x="positionX" :y="positionY" :w="sizeW" :h="sizeH" :z="positionZ" >		
