...
export const AUDIO_IS_PLAYING = create('AUDIO_IS_PLAYING')
export const AUDIO_PROGRESS = create('AUDIO_PROGRESS')
export const AUDIO_DURATION = create('AUDIO_DURATION')
...
export const GALLERY_IS_PLAYING = create('GALLERY_IS_PLAYING')
...
export const FETCH_VARIOUS = create('FETCH_VARIOUS')
