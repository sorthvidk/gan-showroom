...
export const AUDIO_TRACK = createMutation('AUDIO_TRACK')
...
export const AUDIO_SCROLLABLE = createMutation('AUDIO_SCROLLABLE')
export const IS_INTRO = createMutation('IS_INTRO')
